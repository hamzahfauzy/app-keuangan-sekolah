            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary btn-round">Import dari SIAKAD</a>
                        <a href="index.php?r=subjects/create" class="btn btn-secondary btn-round">Buat Subjek</a>
                    </div>
                </div>
            </div>
        </div>
